...
#
# Usage:
#   scripts/sync-private-docs.sh [--dry-run] [--pull-only | --push-only]
#
# Env:
...
# Hard-coded rather than derived from the directory name: git worktrees live under
# .claude/worktrees/<random-name>/ and would otherwise sync to a bogus prefix.
PROJECT_NAME="temporal-commerce-demo"
