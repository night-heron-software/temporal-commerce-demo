...
| [0003](0003-prepare-decide-finalize-state-machines.md)           | `prepare → decide → finalize` state machines on Temporal (no separate domain event-sourcing)         | Accepted (amended by 0024) | yes        |
...
| [0022](0022-one-lifecycle-id-order-keyed-inventory.md)           | One lifecycle id + order-keyed inventory reservations                                                | Accepted                   | yes        |
