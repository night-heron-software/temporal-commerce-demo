...
| Pattern                                         | Where Used                                                                                                       |
| ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| prepare → decide → evolve with a pure decider | [ADR-0003](adr/0003-prepare-decide-evolve-state-machines.md) / [ADR-0009](adr/0009-chassaing-decider-transfer-pilot.md) |
